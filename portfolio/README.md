...
🚀 **[A modern portfolio + blog template built with GatsbyJS and TailwindCSS](https://github.com/gyangunjan94/)** 🚀
...
The about section contains a quick BIO about me.
...
```HTML
    <div id="experience" class="background-alt">
        ...
        <div id="experience-timeline">
            <div data-date="August 2021 – November 2021">
                <h3>Kinsu Hub</h3>
                <h4>Python Trainee</h4>
                <p>
                    A three months training program in Python and GUI capabilities under tight deadlines and performed given tasks. Where I have Learned various Python libraries and Technologies like- Scikit, GUI and Djang.
                </p>
            </div>
...
<div class="education-block">
    ...
    <h2 class="heading">Education</h2>
        <div class="education-block">
            <h3>ROORKEE INSTITUTE OF TECHNOLOGY, UTTRAKHAND, ROORKEE</h3>
            <span class="education-date">2019-2023</span>
            <h4>Bachelor of Technology in Computer Science</h4>
            <p>
                B. Tech (Computer Science & Engineering) <br> Percentage: 64%
            </p>
        </div>
```
